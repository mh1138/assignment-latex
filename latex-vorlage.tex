...
%\input{includes/hauptteil.tex}
\input{includes/01einleitung.tex}
\input{includes/02grundlagen.tex}
\input{includes/03technisch_implementierung.tex}
\input{includes/04praxis.tex}
\input{includes/05fazit.tex}
