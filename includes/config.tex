...
\newcommand{\meinName}{Florian Stahl}

% TODO 2b. Matrikelnummer
\newcommand{\meineMatrikelnummer}{[Matrikelnummer eintragen]}

% TODO 3. Kurs eintragen
\newcommand{\meinKurs}{WWI2025B}

% TODO 4. Titel der Arbeit (für Deckblatt, ehrenwörtliche Erklärung und Metadaten, ohne Umbrüche angeben)
\newcommand{\themaMeinerArbeit}{Implementierung von automatisierten Data-Masking-Verfahren als Schutzmaßnahme gegen Data Leakage bei der Nutzung von LLM-Schnittstellen}

% TODO 5. Angaben zum Unternehmen (wird bei Seminararbeiten nicht angezeigt)
\newcommand{\UNName}{Rober Bosch GmbH}
\newcommand{\UNBetreuer}{Titel, Andreas Schurr}
\newcommand{\UNBetreuerFunktion}{Funktion des Betreuers/der Betreuerin}

% TODO 6. Angaben zur wissenschaftlichen Betreuung 
\newcommand{\DHBWBetreuer}{TitelDHBW Betreuer, Vorname und Nachname}
...
\newcommand{\hatVermerk}{ja}  	% Standard-Einstellung
