...
Eine wesentliche Änderung betrifft den Wortlaut der Erklärung zu KI-Tools. Abschnitt~\ref{sec:tabellen} über Tabellen wurde grundlegend überarbeitet.
...
\hline
2.1 & 11.02.2025 & siehe~\ref{anhang:ReleaseNotes21} \\
\end{tabular}
\end{center}
